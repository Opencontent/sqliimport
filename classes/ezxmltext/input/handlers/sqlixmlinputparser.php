<?php
/**
 * File containing SQLIXMLInputParser
...
/**
 * XML input parser to be used to add rich text (HTML) to a content.
 * Duplicated from ezoe extension.
 * @see http://svn.projects.ez.no/ezoe/trunk/ezoe/ezxmltext/handlers/input/ezoeinputparser.php
 */
class SQLIXMLInputParser extends eZXMLInputParser
{
    /**
